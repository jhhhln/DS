...
#含义是给定常规渠道和加急渠道的inventory position之后如何订货和每条路径的成本
    ...
    def DI_policy(self,demand,sample,x_init=None,q_init=None,inventory_level=0):
        ...
        print(f"最优delta: {optimal_delta}, 最优成本: {DI_cost_record[min_cost_idx]}")
        print(f"对应的(S_e,S_r): ({self.Sr-optimal_delta},{self.Sr})")
...
if __name__ == "__main__":
    ...
    save_order_records(single_source_result, prefix="SingleSource")
save_order_records(ddi_result, prefix="DDI")
save_order_records(TBS_result, prefix="TBS")
