...
#含义是给定常规渠道和加急渠道的inventory position之后如何订货和每条路径的成本
    ...
    def benchmark_DI_policy(self,demand,sample,x_init=None,q_init=None,inventory_level=0):
        ...
        best_Se_record=[]
        for delta in delta_range:
            record=self.cal_order_up_to(sample,self.Se,delta+self.Se,x_init,q_init,inventory_level=0,D_2_constraint=F)
        ...
        record_of_demand=self.cal_order_up_to(demand,optimal_Se,optimal_Se+optimal_delta,x_init,q_init,inventory_level=0)
        return record_of_demand
