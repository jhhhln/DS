...
distribution,c_e,l_r,l_e,service_level,seed_id,b,single_cost,DDI_cost,TBS_cost,DI_cost,random_seed1,random_seed2
# 指定哪些列是参数（不参与平均）
...
# 保存为新文件
df_mean.to_csv("averaged_results.csv", index=False)
