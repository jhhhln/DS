...
#TBS策略中加急渠道是order_up_to,常规渠道是r
    def cal_order_up_to_with_r(self,demand,S_e,r,x_init,q_init,inventory_level=0,constraint_D1=False,constraint_D2=False):
    ...
    def cost_driven_TBS_policy(self,sample,demand,mean,x_init=None,q_init=None,regular=True):
        ...
        optimal_Se = best_Se_record[min_cost_idx]
        if regular:
            record_of_demand=self.cal_order_up_to_with_r(sample,optimal_Se, optimal_r,
                                                x_init, q_init,
                                                inventory_level=0,
                                                constraint_D1=True)
        else:
