...
#含义是给定常规渠道和加急渠道的inventory position之后如何订货和每条路径的成本
    ...
    def DI_policy(self,demand,sample,x_init=None,q_init=None,inventory_level=0):
        ...
        for delta in delta_range:
            record=self.cal_order_up_to(sample,delta,self.Sr,x_init,q_init,inventory_level=0,constraint_D1=False)
        ...
        record_of_demand=self.cal_order_up_to(demand,optimal_delta,self.Sr,x_init,q_init,inventory_level=0,constraint_D1=False)
