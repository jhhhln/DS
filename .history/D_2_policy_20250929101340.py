...
if __name__ == "__main__":
    ...
    print(f"DDI total average cost: {ddi_result['average_total_cost']}")


    print("SDI policy")
    sdi_result = ds.SDI_policy(demand, inventory_level=0)
    print(f"SDI total average cost: {sdi_result['average_total_cost']}")
    ...
    print(f"DI average total cost: {di_cost}")
